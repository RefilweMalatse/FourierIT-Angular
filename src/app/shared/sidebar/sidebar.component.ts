...
export class SidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    { label: 'Departments', icon: 'building', children: [
        ...
        { label: 'Register Department', route: '/departments/register' }
    ]},
    ...
    { label: 'Stakeholders', icon: 'people', children: [
        { label: 'All Stakeholders', route: '/stakeholders/all' },
        { label: 'Add Stakeholder',  route: '/stakeholders/add' }
    ]},
    { label: 'Notifications',  icon: 'bell',  route: '/notifications' },
    { label: 'Access Control', icon: 'lock',  children: [
        { label: 'Permissions', route: '/access-control/permissions' },
        { label: 'Audit Log',   route: '/access-control/audit' }
    ]},
    { label: 'Reports', icon: 'chart', children: [
        { label: 'Activity Reports', route: '/reports/activity' },
        { label: 'Usage Analytics',  route: '/reports/analytics' }
    ]},
    { label: 'System', icon: 'database', children: [
        { label: 'Settings', route: '/system/settings' },
        { label: 'Backup',   route: '/system/backup' }
    ]},
  ];
